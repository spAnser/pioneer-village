...
/**
   ...
   * @return {boolean}
   */
declare function GetEntityPlayerIsFreeAimingAt(player: Player, entity: Entity): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function GetPlayerInteractionTargetEntity(player: Player, outEntity: Entity, p2: boolean, p3: boolean): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function GetPlayerTargetEntity(player: Player, entity: Entity): boolean;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerWeaponDrawSpeed(player: Player, weapon: Hash, speed: number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerPromptLeaveText(player: Player, promptTextKey: string | number): void;
...
/**
   ...
   * @return {void}
   */
declare function N_0x08E22898A6AF4905(player: Player, p1: number): void;
...
/**
   ...
   * @return {void}
   */
declare function ClearDeadeyeAuraIntensityWithFlag(player: Player, bitflag: number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerMeleePromptText(player: Player, label: string | number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetDeadeyeEntityAuraIntensityWithFlag(player: Player, p1: number, p2: number, p3: number, intensity: number, flag: number): void;
...
/**
   ...
   * @return {boolean}
   */
declare function GetPedsDamagedByPlayerRecently(player: Player, duration: number, struct: DataView): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function EagleEyeCanPlayerFocusOnTrack(player: Player): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function IsPlayerOnMountLockonEntity(player: Player): boolean;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeSetRange(player: Player, range: number): void;
...
/**
   ...
   * @return {number}
   */
declare function GetNumDeadeyeMarksOnPed(player: Player, ped: Ped): number;
...
/**
   ...
   * @return {void}
   */
declare function SetDeadeyeEntityAuraWithFlag(player: Player, flag: number): void;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeSetHideAllTrails(player: Player, hide: boolean): void;
...
/**
   ...
   * @return {number}
   */
declare function EagleEyeGetTrackedPedId(player: Player): number;
...
/**
   ...
   * @return {void}
   */
declare function AddAmbientPlayerInteractiveFocusPreset(player: Player, ped: Ped, preset: string | number, x: number, y: number, z: number, targetEntity: Entity, name: string | number): void;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeAddParticleEffectToEntity(entity1: Entity, entity2: Entity, p2: number, p3: number): void;
...
/**
   ...
   * @return {boolean}
   */
declare function HasPlayerDamagedAnyPedRecently(player: Player, duration: number): boolean;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerSitPromptText(playerID: Player, label: string | number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerHatAccess(player: Player, flag: number, allow: boolean): void;
...
/**
   ...
   * @return {boolean}
   */
declare function EagleEyeAreAllTrailsHidden(player: Player): boolean;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerCanPickupHat(player: Player, canPickup: boolean): void;
...
/**
   ...
   * @return {void}
   */
declare function SpecialAbilitySetActivate(player: Player): void;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeSetRegisteredEntityGlow(entity: Entity, enable: boolean): void;
...
/**
   ...
   * @return {void}
   */
declare function DisablePlayerInteractiveFocusPreset(player: Player, name: string | number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerCooperatePromptThisFrame(player: Player, targetPed: Ped, promptOrder: number, p3: boolean): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerAimWeapon(player: Player, weapon: Hash, attachSlotId: number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerPickupPromptVisible(player: Player, enable: boolean): void;
...
/**
   ...
   * @return {Vector3}
   */
declare function AddAmbientPlayerInteractiveFocusPresetAtCoords(player: Player, preset: string | number, x: number, y: number, z: number, targetEntity: Entity, name: string | number): Vector3;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeRemoveParticleEffectFromEntity(entity1: Entity, entity2: Entity, p2: number): void;
...
/**
   ...
   * @return {boolean}
   */
declare function IsSpecialAbilityEnabled(player: Player): boolean;
...
/**
   ...
   * @return {void}
   */
declare function EagleEyeClearRegisteredTrails(player: Player): void;
...
/**
   ...
   * @return {boolean}
   */
declare function IsPlayerMountOnRoad(player: Player): boolean;
...
/**
   ...
   * @return {void}
   */
declare function ResetDeadeyeAuraEffect(player: Player): void;
...
/**
   ...
   * @return {number}
   */
declare function GetDeadeyeAbilityDepletionDelay(player: Player): number;
...
/**
   ...
   * @return {void}
   */
declare function EagleeyeSetSprintBehavior(player: Player, disabled: boolean): void;
...
/**
   ...
   * @return {void}
   */
declare function SetPlayerDeadEyeAuraByHash(player: Player, auraColorHash: Hash): void;
...
/**
   ...
   * @return {void}
   */
declare function SetReceivedDamageTakenOnHorsebackModifier(player: Player, damageDecrease: number): void;
