...
export const weapons: Record<string, WeaponStats> = {
    ...
    [GetHashKey('WEAPON_LASSO_REINFORCED')]: { name: 'WEAPON_LASSO_REINFORCED', modifier: 0, damageType: DamageType.DEFAULT },
    ...
    [GetHashKey('WEAPON_MELEE_BROKEN_SWORD')]: { name: 'WEAPON_MELEE_BROKEN_SWORD', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_CLEAVER')]: { name: 'WEAPON_MELEE_CLEAVER', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_DAVY_LANTERN')]: { name: 'WEAPON_MELEE_DAVY_LANTERN', modifier: 1.0, damageType: DamageType.FIRE },
    ...
    [GetHashKey('WEAPON_MELEE_KNIFE_BEAR')]: { name: 'WEAPON_MELEE_KNIFE_BEAR', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_BILL')]: { name: 'WEAPON_MELEE_KNIFE_BILL', modifier: 1.0, damageType: DamageType.SHARP },
    ...
    [GetHashKey('WEAPON_MELEE_KNIFE_DUTCH')]: { name: 'WEAPON_MELEE_KNIFE_DUTCH', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_HOSEA')]: { name: 'WEAPON_MELEE_KNIFE_HOSEA', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_JAVIER')]: { name: 'WEAPON_MELEE_KNIFE_JAVIER', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_JAWBONE')]: {
        name: 'WEAPON_MELEE_KNIFE_JAWBONE',
        modifier: 1.0,
        damageType: DamageType.SHARP,
    },
    [GetHashKey('WEAPON_MELEE_KNIFE_JOHN')]: { name: 'WEAPON_MELEE_KNIFE_JOHN', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_KIERAN')]: { name: 'WEAPON_MELEE_KNIFE_KIERAN', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_LENNY')]: { name: 'WEAPON_MELEE_KNIFE_LENNY', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_MICAH')]: { name: 'WEAPON_MELEE_KNIFE_MICAH', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_MINER')]: { name: 'WEAPON_MELEE_KNIFE_MINER', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_SADIE')]: { name: 'WEAPON_MELEE_KNIFE_SADIE', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_SEAN')]: { name: 'WEAPON_MELEE_KNIFE_SEAN', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_TRADER')]: { name: 'WEAPON_MELEE_KNIFE_TRADER', modifier: 1.0, damageType: DamageType.SHARP },
    [GetHashKey('WEAPON_MELEE_KNIFE_UNCLE')]: { name: 'WEAPON_MELEE_KNIFE_UNCLE', modifier: 1.0, damageType: DamageType.SHARP },
    ...
    [GetHashKey('WEAPON_MELEE_TORCH_CROWD')]: { name: 'WEAPON_MELEE_TORCH_CROWD', modifier: 1.0, damageType: DamageType.FIRE },
    [GetHashKey('WEAPON_MOONSHINEJUG')]: { name: 'WEAPON_MOONSHINEJUG', modifier: 1.0, damageType: DamageType.FIRE },
    [GetHashKey('WEAPON_MOONSHINEJUG_MP')]: { name: 'WEAPON_MOONSHINEJUG_MP', modifier: 1.0, damageType: DamageType.FIRE },
    ...
    [GetHashKey('WEAPON_REPEATER_CARBINE')]: { name: 'WEAPON_REPEATER_CARBINE', modifier: 5.0, damageType: DamageType.GUN },
    ...
    [GetHashKey('WEAPON_REVOLVER_CATTLEMAN')]: { name: 'WEAPON_REVOLVER_CATTLEMAN', modifier: 5.0, damageType: DamageType.GUN },
    ...
    [GetHashKey('WEAPON_REVOLVER_SCHOFIELD')]: { name: 'WEAPON_REVOLVER_SCHOFIELD', modifier: 5.0, damageType: DamageType.GUN },
    ...
    [GetHashKey('WEAPON_RIFLE_BOLTACTION')]: { name: 'WEAPON_RIFLE_BOLTACTION', modifier: 5.0, damageType: DamageType.GUN },
    [GetHashKey('WEAPON_RIFLE_BOLTACTION_BILL')]: {
        name: 'WEAPON_RIFLE_BOLTACTION_BILL',
        modifier: 5.0,
        damageType: DamageType.GUN,
    },
    [GetHashKey('WEAPON_RIFLE_SPRINGFIELD')]: { name: 'WEAPON_RIFLE_SPRINGFIELD', modifier: 5.0, damageType: DamageType.GUN },
    [GetHashKey('WEAPON_RIFLE_VARMINT')]: { name: 'WEAPON_RIFLE_VARMINT', modifier: 5.0, damageType: DamageType.GUN },
    [GetHashKey('WEAPON_RUN_OVER_BY_CAR')]: { name: 'WEAPON_RUN_OVER_BY_CAR', modifier: 1.0, damageType: DamageType.BLUNT },
    ...
    [GetHashKey('WEAPON_SHOTGUN_SAWEDOFF')]: { name: 'WEAPON_SHOTGUN_SAWEDOFF', modifier: 5.0, damageType: DamageType.GUN },
    [GetHashKey('WEAPON_SHOTGUN_SAWEDOFF_CHARLES')]: {
        name: 'WEAPON_SHOTGUN_SAWEDOFF_CHARLES',
        modifier: 5.0,
        damageType: DamageType.GUN,
    },
    [GetHashKey('WEAPON_SHOTGUN_SEMIAUTO')]: { name: 'WEAPON_SHOTGUN_SEMIAUTO', modifier: 5.0, damageType: DamageType.GUN },
    ...
    [GetHashKey('WEAPON_THROWN_DYNAMITE')]: { name: 'WEAPON_THROWN_DYNAMITE', modifier: 10.0, damageType: DamageType.EXPLOSIVE },
    ...
    [GetHashKey('WEAPON_THROWN_TOMAHAWK')]: { name: 'WEAPON_THROWN_TOMAHAWK', modifier: 1.0, damageType: DamageType.SHARP },
    ...
    [GetHashKey('WEAPON_TURRET_CANNON')]: { name: 'WEAPON_TURRET_CANNON', modifier: 10, damageType: DamageType.EXPLOSIVE },
