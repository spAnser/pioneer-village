...
/**
   ...
   * @return {number}
   */
declare function GetLastPlayedSpeechForPed(ped: Ped): number;
...
/**
   ...
   * @return {void}
   */
declare function PlaySoundFromCoord(SoundName: string | number, positionX: number, positionY: number, positionZ: number, SetName: string | number, bOverNetwork: boolean, nNetworkRange: number, isExteriorLoc: boolean, p8: number): void;
...
/**
   ...
   * @return {void}
   */
declare function SetVariableOnSound(soundId: number, variableName: string | number, variableValue: number): void;
