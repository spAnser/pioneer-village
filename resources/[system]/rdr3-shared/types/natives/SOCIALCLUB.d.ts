/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetDisplayName(p0: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetDisplayNameById(p0: number, p1: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetDisplayNameForType(p0: string | number, p1: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetExtraDataString(p0: string | number, p1: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetExtraDataStringById(p0: number, p1: string | number, p2: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScCommunityEventGetExtraDataStringForType(p0: string | number, p1: string | number, p2: string | number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function ScInboxMessageGetDataString(p0: number, context: string | number, out: string | number): boolean;
