 ...
 * @return {any}
 */
declare function IsNearMount(p0: number): any;
 ...
 * @return {void}
 */
declare function UiPromptSetMashWithResistanceCanFailMode(prompt: Prompt, mashes: number, p2: number, p3: number): void;
