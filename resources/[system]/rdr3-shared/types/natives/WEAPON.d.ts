...
/**
   ...
   * @return {boolean}
   */
declare function HasPedGotWeapon(ped: Ped, weaponHash: Hash, p2: number, onlyCheckPlayerInventory: boolean): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function IsPedHoldingWeapon(ped: Ped, weapon: Hash): boolean;
...
/**
   ...
   * @return {number}
   */
declare function GetNumPedsRestrainedFromWeaponBolas(ped: Ped): number;
...
/**
   ...
   * @return {void}
   */
declare function SetPedWeaponOnBack(ped: Ped, disableAnim: boolean): void;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHaveRepeater(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function GetWeaponHasMultipleAmmoTypes(weaponHash: Hash): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function N_0x5A695BD328586B44(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHaveRevolver(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {number}
   */
declare function GetDefaultWeaponAttachPoint(weaponHash: Hash): number;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHaveSniper(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHaveRifle(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {number}
   */
declare function GetWeaponFromDefaultPedWeaponCollection(weaponCollection: number, weaponGroup: Hash): number;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHaveShotgun(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {void}
   */
declare function SetInstantlyStoreLongarmsOnDismount(ped: Ped, storeLongarms: boolean, p2: number): void;
...
/**
   ...
   * @return {boolean}
   */
declare function DoesPedHavePistol(ped: Ped, p1: number): boolean;
...
/**
   ...
   * @return {boolean}
   */
declare function IsWeaponCloseRange(weaponHash: Hash): boolean;
