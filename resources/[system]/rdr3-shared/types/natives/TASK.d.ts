 ...
 * @return {number}
 */
declare function GetScenarioPointsInArea(posX: number, posY: number, posZ: number, radius: number, scenariosInRadius: DataView, size: number): number;
 ...
 * @return {void}
 */
declare function PlayEntityScriptedAnim(entity: Entity, args: DataView): void;
 ...
 * @return {void}
 */
declare function TaskDuck(ped: Ped, p1: number): void;
 ...
 * @return {void}
 */
declare function TaskFollowPavementToCoord(ped: Ped, args: DataView): void;
 ...
 * @return {void}
 */
declare function TaskGoStraightToCoord(ped: Ped, x: number, y: number, z: number, moveBlendSpeedY: number, p5: number, p6: number, p7: number, p8: number): void;
 ...
 * @return {void}
 */
declare function TaskGoStraightToCoordRelativeToEntity(ped: Ped, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any, p7: any): void;
 ...
 * @return {Vector3}
 */
declare function TaskGoToCoordAnyMeansExtraParamsWithCruiseSpeed(ped: Ped, cruiseSpeed: number, entity: Entity, p4: number, p5: number, p6: any, p7: any, p8: any, p9: any, p10: any, p11: any, cruiseSpeed: number, p13: any, p14: any): Vector3;
 ...
 * @return {void}
 */
declare function TaskMoveNetworkAdvancedByNameWithInitParams(ped: Ped, moveNetworkDefName: string | number, taskData: DataView, xPos: number, yPos: number, zPos: number, xRot: number, yRot: number, zRot: number, p9: number, p10: number, p11: number, p12: number, flag: number, p14: number): void;
 ...
 */
declare function WaypointRecordingGetClosestWaypoint(waypointRecording: string | number, x: number, y: number, z: number): [boolean, number];
 ...
 * @return {[boolean, number]}
 */
declare function WaypointRecordingGetNumPoints(waypointRecording: string | number): [boolean, number];
 ...
 * @return {void}
 */
declare function N_0xB35370D5353995CB(ped: Ped, item: Hash, p2: number): void;
 ...
 * @return {number}
 */
declare function CreateHerbComposites(asset: Hash, x: number, y: number, z: number, heading: number, groundSetting: number, p6: DataView, p7: number): number;
 ...
 * @return {boolean}
 */
declare function CreateWaypointPath(pathName: string | number, p1: DataView, nodes: number, p3: number): boolean;
 ...
 * @return {boolean}
 */
declare function SetTaskFishing(ped: Ped, p1: DataView): boolean;
 ...
 * @return {void}
 */
declare function TaskCombatPed_3(p0: any, p1: any, p2: any, p3: any, p4: any, p5: any): void;
 ...
 * @return {void}
 */
declare function TaskPerformSequence_2(p0: any, p1: any, p2: any, p3: any): void;
