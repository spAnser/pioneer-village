 ...
 * @return {boolean}
 */
declare function StartParticleFxNonLoopedAtCoord(effectName: string | number, xPos: number, yPos: number, zPos: number, xRot: number, yRot: number, zRot: number, scale: number, xAxis: boolean, yAxis: boolean, zAxis: boolean): boolean;
