 ...
 * @return {void}
 */
declare function N_0xB7DF150605EEDC9B(entity: Entity, p1: number, x: number, y: number, z: number, explosionType: number, damageScale: number, isAudible: boolean, isInvisible: boolean, cameraShake: number): void;
